...
use crate::{
    AppError,
    api::types::{
        Configuration, DeviceConfiguration, Event, FolderConfiguration, PendingDevices,
        PendingFolders,
    },
};
...
impl Client {
    ...
    #[must_use]
    pub async fn post_folder(&self, folder: FolderConfiguration) -> eyre::Result<(), AppError> {
    ...
    #[must_use]
    pub async fn add_device(&self, device: DeviceConfiguration) -> eyre::Result<(), AppError> {
